...
on broadCastMouseEvent me, bDoubleClick
  put "received broadcastMouseEvent"
...
on destroyObjects me
  ...
  repeat with sprite_number = me.oIsoConstants.DEFAULT_SPRITE_COUNTER to me.oIsoConstants.DEFAULT_SPRITE_COUNTER_MAX
    puppetSprite(sprite_number, 0)
  end repeat
  me.oSelectedItem = VOID
end
