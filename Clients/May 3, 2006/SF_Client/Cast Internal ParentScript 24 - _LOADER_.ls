...
on openWindow me
  ...
  sprite(me.iStatusSprite).member = member("Tip")
  sprite(me.iStatusSprite).rect = rect(222, 360, 539, 376)
  sprite(me.iStatusSprite).ink = 36
  sprite(me.iStatusSprite).visible = 1
