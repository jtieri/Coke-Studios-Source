...
on setCallbacks me
  ...
  sprite(me.spriteNum).setCallback(me.foDenizenManager, "getCokeBulletinURL_Result", #getCokeBulletinURL_result, me)
  sprite(me.spriteNum).setCallback(me.foDenizenManager, "updateBulletinURL_result", #updateBulletinURL_result, me)
end
...
on getDenizenByScreenName me, sScreenName
  ...
  me.foDenizenManager.getDenizenByScreenName(me.getDenizen().getScreenName(), me.getDenizen().getSecret(), sScreenName)
end
...
on getCokeBulletinURL me
  me.foDenizenManager.getCokeBulletinURL()
end

on getCokeBulletinURL_result me, oCaller, oResult
  global ElementMgr
  ElementMgr.URLdialog("ALERT_EXTERNAL_URL", oResult)
end

on updateBulletinURL me, myscreenname, myKey, myPosId, myURL
  me.foDenizenManager.updateBulletinURL(myscreenname, myKey, myPosId, myURL)
end

on updateBulletinURL_result me, oCaller, oResult
  put "result:" && oResult
  ElementMgr.alert("ALERT_ICOKE_URL_" & integer(oResult))
end
