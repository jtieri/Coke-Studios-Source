...
on endSprite me
  sprite(me.spriteNum).member.paletteRef = member("tokyo_discofloor_peaceful_1")
end
...
on init me
  ...
  me.aPatternNames = ["tokyo_discofloor_peaceful_", "tokyo_discofloor_action_", "tokyo_discofloor_switch_"]
  me.aPatternMembers = []
...
on exitFrame me
  if me.iState = 1 then
    iElapsedTime = the milliSeconds - me.iPatternTimer
    if iElapsedTime >= me.iPatternTimeLength then
      me.nextPattern(1)
      me.iPatternTimer = the milliSeconds
    end if
  end if
